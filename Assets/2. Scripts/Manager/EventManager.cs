...
public class EventManager
{
    ...
    public List<string[]> SetRandomItem(PlayerStats player, int Maxcount)
    {
        int i = 0;
    ...
    /*public void DropItem(EnemyStats stat, Transform transform)
    {
    ...
    /*public void LevelUpOverEvent(int itemType, string itemName)
    {
        ...
        PlayerStats player = Managers.Game.getPlayer().GetComponent<PlayerStats>();
        if (itemType == 1)
        {
            switch (itemName)
            {
    ...
    public List<Define.Weapons> SetRandomWeaponfromItemBox(PlayerStats player)
    {
